...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeAgricoinmn = new QSpinBox(tabMain);
        anonymizeAgricoinmn->setObjectName(QStringLiteral("anonymizeAgricoinmn"));
        anonymizeAgricoinmn->setMinimum(2);
        anonymizeAgricoinmn->setMaximum(10000);
        anonymizeAgricoinmn->setSingleStep(10);
        anonymizeAgricoinmn->setValue(1000);

        gridLayout->addWidget(anonymizeAgricoinmn, 7, 1, 1, 1);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Agricoinmn after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Agricoinmn on system login", 0));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Agricoinmn to keep anonymized", 0));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", 0));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Agricoinmn client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Agricoinmn network through a SOCKS5 proxy (e.g. when connecting through Tor).", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Agricoinmn.", 0));
#endif // QT_NO_TOOLTIP

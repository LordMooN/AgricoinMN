...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Agricoinmn - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "Agricoinmn Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Agricoinmn debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Agricoinmn-Qt help message to get a list with possible Agricoinmn command-line options.", 0));
#endif // QT_NO_TOOLTIP

...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 AGCMN"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 AGCMN"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 AGCMN"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 AGCMN"));

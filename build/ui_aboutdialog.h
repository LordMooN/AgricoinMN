...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Agricoinmn", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Agricoinmn</b> version", 0));
...
"Copyright \302\251 2014 The Agricoinmn developers", 0));

...
DISTDIR = /root/AgricoinMN/build/agricoinmn-qt1.0.0.2
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 /root/AgricoinMN/src/leveldb/libleveldb.a /root/AgricoinMN/src/leveldb/libmemenv.a /root/AgricoinMN/src/secp256k1/src/libsecp256k1_la-secp256k1.o -lssl -lcrypto -ldb_cxx -lgmp -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lQt5PrintSupport -lQt5Widgets -lQt5Gui -lQt5Network -lQt5DBus -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
clean: compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /root/AgricoinMN/src/leveldb/libleveldb.a; cd /root/AgricoinMN/src/leveldb ; $(MAKE) clean /root/AgricoinMN/src/secp256k1/src/libsecp256k1_la-secp256k1.o; cd /root/AgricoinMN/src/secp256k1; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/root/AgricoinMN/src/leveldb/libleveldb.a: FORCE
	cd /root/AgricoinMN/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/root/AgricoinMN/src/secp256k1/src/libsecp256k1_la-secp256k1.o: FORCE
	cd /root/AgricoinMN/src/secp256k1 && ./autogen.sh && ./configure --enable-module-recovery && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2"

/root/AgricoinMN/build/build.h: FORCE
	cd /root/AgricoinMN; /bin/sh share/genbuild.sh /root/AgricoinMN/build/build.h
...
build/moc_bitcoingui.cpp: src/qt/bitcoingui.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I/root/AgricoinMN -I/root/AgricoinMN/src -I/root/AgricoinMN/src/json -I/root/AgricoinMN/src/qt -I/root/AgricoinMN/src/qt/plugins/mrichtexteditor -I/root/AgricoinMN/src/leveldb/include -I/root/AgricoinMN/src/leveldb/helpers -I/root/AgricoinMN/src/secp256k1/include -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtPrintSupport -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtNetwork -I/usr/include/x86_64-linux-gnu/qt5/QtDBus -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/5 -I/usr/include/x86_64-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/x86_64-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/5/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include src/qt/bitcoingui.h -o build/moc_bitcoingui.cpp

...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeAgricoinmnAmount"))
        settings.setValue("nAnonymizeAgricoinmnAmount", 1000);
    nAnonymizeAgricoinmnAmount = settings.value("nAnonymizeAgricoinmnAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeAgricoinmnAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeAgricoinmnAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeAgricoinmnAmount:
            return QVariant(nAnonymizeAgricoinmnAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeAgricoinmnAmount:
            nAnonymizeAgricoinmnAmount = value.toInt();
            settings.setValue("nAnonymizeAgricoinmnAmount", nAnonymizeAgricoinmnAmount);
            emit AnonymizeAgricoinmnAmountChanged(nAnonymizeAgricoinmnAmount);
            break;
        default:
            break;
        }
